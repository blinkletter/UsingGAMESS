...
# # 3. Getting Started with Small Molecules
# 
...
# 
# ```{note}
# Don't think about it too much. the two levels of rigour described below are nowhere near the state of the art, but they will serve for what we need to do. To understand the theory and the choice of orbital basis sets you should enjoy the computational chemistry course that is taking place in parallel with this course. We can use GAMESS without having a clue what we are doing. Lives are not at stake here.
# ```
# 
...
# ```
# 
# The HF/6311G(d,p)++ energy was -76.0534 Hartrees whereas the HF/3-21G energy was -75.5860 Hartrees. Higher levels of theory will give lower energy values.  The bond length is now shorter.
# 
# ```{note}
